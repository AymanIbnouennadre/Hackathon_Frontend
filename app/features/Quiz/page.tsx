...
import { Play, Pause, ArrowLeft, ArrowRightCircle, RefreshCw, Sparkles, Volume2, Trophy, Star, XCircle } from "lucide-react";
...
const LoseAudio = new Audio("/lost.wav");
          ...
          {language ? (
            quizCompleted ? (
              <div className="end-quiz-container">
                <Trophy className="end-quiz-icon" />
                <h2>{language === "french" ? "Quiz Terminé !" : "انتهى الاختبار!"}</h2>
                <p>
                  {language === "french"
                    ? `Total des trésors : ${treasures}`
                    : `مجموع الكنوز: ${treasures}`}
                </p>
                <div className="flex justify-center gap-3 mt-4">
                  <button className="action-btn back" onClick={handleBackToLanguageChoice}>
                    {language === "french" ? "Choix de langue" : "اختيار اللغة"}
                    <ArrowLeft className="ml-2 h-5 w-5" />
                  </button>
                  <button className="action-btn restart" onClick={handleRestartQuiz}>
                ...
                {feedback && currentQuestion && (
                  <div className="feedback-container">
                    ...
                    <div className="text-center mt-4">
                      {feedback.includes("Bravo") || feedback.includes("أحسنت") ? (
                        <button className="action-btn correct" onClick={handleNextQuestion}>
            ...
            <div className="text-center">
              ...
              >
                <Volume2 className="inline-block mr-2 h-8 w-8" /> Quiz Audio |{" "}
