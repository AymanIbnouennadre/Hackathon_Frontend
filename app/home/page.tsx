      ...
      <CardContent className="p-6 backdrop-blur-sm relative">
        <div className="flex items-start">
          ...
          <div>
            ...
            <Button className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700 border-0 shadow-lg shadow-purple-700/30 transition-all duration-300 hover:shadow-xl hover:shadow-purple-700/40">
              {buttonText}
            </Button>
          </div>
        </div>
  ...
  return (
    <Card className="bg-transparent border-white/10 overflow-hidden group relative hover:shadow-xl transition-all duration-500 hover:-translate-y-1">
      ...
      <CardContent className="p-6 backdrop-blur-sm relative">
        ...
        <Button variant="outline" className="w-full border-white/20 text-gray-200 hover:bg-white/10 hover:text-white">
          Try Now
        </Button>
      </CardContent>
    </Card>
